...
function Button({text, alt, name, iconsrc, customstyle={}, onClick, onMouseEnter, onMouseLeave}) {
  ...
  return (
    <>
      { text?
        ...
        <button onMouseLeave={onMouseLeave} onClick={onClick} onMouseEnter={onMouseEnter} className='iconbtn custom-hover'  style={{...customstyle}} ><img src={iconsrc} alt={alt}/></button> : //icon button
